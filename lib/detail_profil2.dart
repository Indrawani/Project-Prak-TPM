...
class HalamanProfilErgy extends StatefulWidget {
  const HalamanProfilErgy({Key? key}) : super(key: key);

  @override
  State<HalamanProfilErgy> createState() => _HalamanProfilErgyState();
}

class _HalamanProfilErgyState extends State<HalamanProfilErgy> {
  int _currentIndex = 0;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text('Harapan'),
                      subtitle: Text('Cepat Lulus, dan keliling dunia'),
                    ),
                    SizedBox(height: 16),
                  ],
                ),
